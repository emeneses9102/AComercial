      ...
      >
        ...
        >
          <b-form-group
            ...
            label-for="article-minium-sale-price"
          >
            <b-form-input
              id="article-minium-sale-price"
...
<script>
import {
  BForm, BRow, BCol, BFormGroup, BFormInput, BBadge, BFormTextarea,
} from 'bootstrap-vue'
