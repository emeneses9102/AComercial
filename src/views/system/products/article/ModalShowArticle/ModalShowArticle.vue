<template>
  <b-modal
    ...
    centered
    size="lg"
    :title="`Ver ${titleNotificationArticle}`"
...
import DetailTableChildrenSerie from './DetailTableChildrenSerie.vue'
