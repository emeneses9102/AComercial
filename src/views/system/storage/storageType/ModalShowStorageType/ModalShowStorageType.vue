<template>
  <b-modal
    :id="`${MODAL_ID}-show`"
    centered
    :title="`Ver ${titleNotificationStorageType}`"
...
import { MODAL_ID, titleNotificationStorageType, stateStorageType } from '../ServicesStorageType/useVariablesStorageType'

export default {
  name: 'ModalShowStorageType',
  components: {
    BModal,
    BForm,
    BRow,
