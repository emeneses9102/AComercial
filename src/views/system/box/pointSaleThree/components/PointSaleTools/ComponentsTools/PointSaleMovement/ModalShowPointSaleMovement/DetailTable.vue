<template>
  <field-set-component legend="Listado">
    ...
    <table-good-component
      ...
      :columns="columnsPointSaleMovementForShow"
...
import {
  columnsPointSaleMovementForShow, serverQueryPointSaleMovement, dataTablePointSaleMovement, columnsFilterPointSaleMovement, titleNotificationPointSaleMovement,
...
export default {
  ...
  setup() {
    ...
    return {
      statePointSale,
      columnsPointSaleMovementForShow,
