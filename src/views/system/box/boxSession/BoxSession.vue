...
import {
  MODAL_ID, clearStateBoxSession, columnsBoxSession, urlApiBoxSession, titleNotificationBoxSession, serverQueryBoxSession, columnsFilterBoxSession, titleReportBoxSession, combosBoxSession,
} from './ServicesBoxSession/useVariablesBoxSession'
import {
  clearStateBoxSessionDetail, clearDataTableBoxSessionDetail, clearFiltersBoxSessionDetail, combosBoxSessionDetail,
