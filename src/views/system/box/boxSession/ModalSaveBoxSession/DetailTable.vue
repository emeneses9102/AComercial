...
import {
  stateBoxSessionDetail, columnsBoxSessionDetail, serverQueryBoxSessionDetail, dataTableBoxSessionDetail, columnsFilterBoxSessionDetail, titleNotificationBoxSessionDetail,
